...
resource "kubernetes_ingress" "canopy_v2" {
  ...
  spec {
    rule {
      host = "canopy.${var.environment}.${var.dns_realm}-red.${var.region}.${var.cloud}.sapienceanalytics.com"
      http {
        path {
          backend {
    ...
    tls {
      hosts = [
        "canopy.${var.environment}.${var.dns_realm}-red.${var.region}.${var.cloud}.sapienceanalytics.com",
