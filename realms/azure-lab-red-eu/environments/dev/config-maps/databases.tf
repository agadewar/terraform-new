resource "kubernetes_config_map" "databases" {
  ...
  data = {
      "sql_server_name"                                = "sapience-lab-eu-dev.database.windows.net"
      "data_warehouse"                                 = "edw"
      "api_service_account"                            = "appsvc_api_user"
      "machine_learning_service_account"               = "appsvc_ml_user"
      "MongoDBConnectorSettings__ServerName"           = "sapience-integration-mongodb-lab-eu-dev.mongo.cosmos.azure.com"
      ...
      "MongoDBConnectorSettings__UserName"             = "sapience-integration-mongodb-lab-eu-dev"
  }
}