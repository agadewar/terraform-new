...
resource "kubernetes_deployment" "canopy_settings_service_deployment" {
  ...
  spec {
    replicas = var.canopy_settings_service_deployment_replicas
    ...
    template {
      ...
      spec {
        container {
          ...
          image = "${var.canopy_container_registry_hostname}/canopy-settings-service:1.2.1-20211217142304793"
          name  = "canopy-settings-service"
          ...
          resources {
            requests {
              memory = var.canopy_settings_service_deployment_request_memory
              cpu    = var.canopy_settings_service_deployment_request_cpu
            }
          }
