...
resource "azurerm_subnet" "aks-pool01" {
  ...
  service_endpoints    = var.subnet_service_endpoints
 #route_table_id       = "/subscriptions/b78a61e7-f2ed-4cb0-8f48-6548408935e9/resourceGroups/MC_lab-us_lab-us-red_eastus/providers/Microsoft.Network/routeTables/aks-agentpool-34839511-routetable"
}
