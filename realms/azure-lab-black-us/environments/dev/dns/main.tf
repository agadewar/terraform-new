...
resource "azurerm_dns_a_record" "user_upload_black" {
  name                = "admin.upload.${var.environment}.${var.dns_realm}-black.${var.region}.${var.cloud}"
  zone_name           = "sapienceanalytics.com"
  resource_group_name = "global-us"
  ttl                 = 300
  # TF-UPGRADE-TODO: In Terraform v0.10 and earlier, it was sometimes necessary to
...
resource "azurerm_dns_a_record" "help_black" {
  name                = "help.${var.environment}.${var.dns_realm}-black.${var.region}.${var.cloud}"
  zone_name           = "sapienceanalytics.com"
  resource_group_name = "global-us"
  ttl                 = 30
  # TF-UPGRADE-TODO: In Terraform v0.10 and earlier, it was sometimes necessary to
...
resource "azurerm_dns_a_record" "canopy_black" {
  name                = "canopy.${var.environment}.${var.dns_realm}-black.${var.region}.${var.cloud}"
  zone_name           = "sapienceanalytics.com"
  resource_group_name = "global-us"
  ttl                 = 30
  # TF-UPGRADE-TODO: In Terraform v0.10 and earlier, it was sometimes necessary to
...
resource "azurerm_dns_a_record" "canopyv3_black" {
  name                = "canopyv3.${var.environment}.${var.dns_realm}-black.${var.region}.${var.cloud}"
  zone_name           = "sapienceanalytics.com"
  resource_group_name = "global-us"
  ttl                 = 30
  # TF-UPGRADE-TODO: In Terraform v0.10 and earlier, it was sometimes necessary to
